...
//  Habiba Yasser 202102862
// 	Abdullah Sebai 202102222
// 	Yassin Walid 202100693
#include <iostream>
#include <vector>
#include <string>
#include <fstream>
using namespace std;
// function that checks that the inputs are all digits and are 4 digits in total (Abdelrahman Eweis)
...
// function that turns all the letters in a word lowercase to make sure that whoever is searching or inputing doesn't get the result they want just because the capitalized (Abdelrahman Eweis)
...
// function that turns the sentences in a file to a vector of each word (Abdelrahman Eweis)
...
// class for the renters (Abdelrahman Eweis)
class Renter
{
private:
...
public:
    ...
    // setters and getters for all the attributes of the renter (Abdelrahman Eweis)
...
public:
    ...
    // necessary setters and getters for the car brand (Abdelrahman eweis and Yassin Walid)
...
public:
    // The constructor for the system that takes all the cars from the file and and appends it to the vector accordingly (Abdelrahman Eweis and Yassin Walid)
    CarRental()
    {
        Car c;
        Renter r;
    ...
    // adds new cars to the vector list so they can later be used in other parts of the code (Habiba Yasser)
    ...
    // searches for cars and states whether they are rented or not (Yassin Walid)
    ...
    // adds new renters to a vector so they can later be used to rent cars (Habiba Yasser)
    ...
    // looks for unused renters and sets them to the cars they want to rent (Abdelrahman Eweis)
    ...
    // looks for renters adn swaps them out for a completely new renter(Yassin Walid)
    ...
    // removes renters form cars so they can be rented at a later time by new renters(Abdullah Sebai)
    ...
    // goes through the edited vector and writes it back in to the file so it can be saved (Abdelrahman Eweis)
    void quitSave()
    {
        ofstream editedFile;
...
// main function that runs all the methods required for the user's actions (Abdelrahman Eweis)
int main()
{
    try
    {
